	 ...
	 protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if(usuarioLogado.getPerfil().equals("ADM")) {
				 ...
				 for (Usuario usuario : usuarios) {
					...
					linhasDaTabela.append("			<a href=\"cadastroUsuario?action=update&nome=" + usuario.getNome() + "\" class=\"btn-editar\">Editar</button>\r\n");
					linhasDaTabela.append("    <td>\r\n");
				 ...
				 String htmlResponse = "<!DOCTYPE html>\r\n"
				 		...
				 		+ "        <label>Nome:</label>\r\n"
				 		+ "        <input value=\""+nomeUsuario+"\" type=\"text\" id=\"nome\" name=\"nome\">\r\n"
				 		+ "\r\n"
				 		+ "        <label>Senha:</label>\r\n"
				 		...
				 		+ "        </select>\r\n"
				 		+ "\r\n"
				 		+ "        <button class=\"btn-enviar\" type=\"submit\">"+btnForm+"</button>\r\n"
				 		+ "    </form>\r\n"
				 		+ "\r\n"
